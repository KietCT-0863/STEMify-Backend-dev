...
{
    /// <inheritdoc />
    public partial class InitialWithOpenIddictComplete : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role = table.Column<string>(
                        ...
                        maxLength: 20,
                        nullable: false,
                        comment: "User role (Teacher, Student, etc.)"
                    ),
                    Status = table.Column<string>(
                        type: "character varying(20)",
                        maxLength: 20,
                        nullable: false,
                        comment: "User status (Active, Pending, Disabled, etc.)"
                    ),
                    ...
                    LastLoginAt = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: true,
                        comment: "User last login timestamp"
                    ),
                    EmailConfirmedAt = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: true,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Major = table.Column<string>(
                        type: "varchar(100)",
                        maxLength: 100,
                        nullable: true,
                        comment: "Student major/field of study"
                    ),
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bio = table.Column<string>(
                        ...
                        maxLength: 500,
                        nullable: true,
                        comment: "Teacher biography/description"
                    ),
                    Specialization = table.Column<string>(
                        type: "varchar(200)",
                        maxLength: 200,
                        nullable: true,
                        comment: "Teacher specialization/subject area"
                    ),
                },
                constraints: table =>
                {
