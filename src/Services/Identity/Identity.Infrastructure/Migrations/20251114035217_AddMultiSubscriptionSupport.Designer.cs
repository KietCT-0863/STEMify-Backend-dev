...
namespace Identity.Infrastructure.Migrations
{
    ...
    [Migration("20251114035217_AddMultiSubscriptionSupport")]
    partial class AddMultiSubscriptionSupport
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Identity.Domain.Entities.OrganizationUser", b =>
                {
                    ...
                    b.Property<int>("SubscriptionOrderId")
                        .HasColumnType("integer")
                        .HasComment("Subscription order ID from Order Service - REQUIRED for multi-subscription support");
                    ...
                    b.HasIndex("OrganizationId", "UserId", "SubscriptionOrderId")
                        .IsUnique()
                        .HasDatabaseName("IX_OrganizationUsers_Org_User_Subscription");
