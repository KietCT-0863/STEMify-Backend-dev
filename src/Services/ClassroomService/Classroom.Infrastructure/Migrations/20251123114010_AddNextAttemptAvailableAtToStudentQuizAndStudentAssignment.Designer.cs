...
namespace Classroom.Infrastructure.Migrations
{
    ...
    [Migration("20251123114010_AddNextAttemptAvailableAtToStudentQuizAndStudentAssignment")]
    partial class AddNextAttemptAvailableAtToStudentQuizAndStudentAssignment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Classroom.Domain.Entities.AssignmentAttempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("StudentAssignmentId", "AttemptNumber")
                        .IsUnique()
            ...
            modelBuilder.Entity("Classroom.Domain.Entities.AssignmentQuestionAttempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("AssignmentAttemptId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AssignmentAttemptId", "AssignmentQuestionId")
                        .IsUnique()
                        .HasDatabaseName("IX_AssignmentQuestionAttempt_AssignmentAttemptId_QuestionId");

                    b.ToTable("AssignmentQuestionAttempts");
                });
            ...
            modelBuilder.Entity("Classroom.Domain.Entities.RubricScore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("AssignmentQuestionAttemptId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AssignmentQuestionAttemptId")
                    ...
                    b.HasIndex("AssignmentQuestionAttemptId", "RubricCriterionId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Classroom.Domain.Entities.StudentAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("NextAttemptAvailableAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Classroom.Domain.Entities.AssignmentAttempt", b =>
                {
                    b.HasOne("Classroom.Domain.Entities.StudentAssignment", "StudentAssignment")
            ...
            modelBuilder.Entity("Classroom.Domain.Entities.AssignmentQuestionAttempt", b =>
                {
                    b.HasOne("Classroom.Domain.Entities.AssignmentAttempt", "AssignmentAttempt")
                        .WithMany("AssignmentQuestionAttempts")
            ...
            modelBuilder.Entity("Classroom.Domain.Entities.CurriculumEnrollment", b =>
                {
                    b.HasOne("Classroom.Domain.Entities.Classroom", "Classroom")
                        .WithMany("CurriculumEnrollments")
                        .HasForeignKey("ClassroomId");
            ...
            modelBuilder.Entity("Classroom.Domain.Entities.RubricScore", b =>
                {
                    b.HasOne("Classroom.Domain.Entities.AssignmentQuestionAttempt", "AssignmentQuestionAttempt")
                        .WithMany("RubricScores")
                        .HasForeignKey("AssignmentQuestionAttemptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AssignmentQuestionAttempt");
                });

            modelBuilder.Entity("Classroom.Domain.Entities.StudentAssignment", b =>
                {
                    b.HasOne("Classroom.Domain.Entities.StudentSectionProgress", "StudentSectionProgress")
                        .WithOne("StudentAssignment")
                        .HasForeignKey("Classroom.Domain.Entities.StudentAssignment", "StudentSectionProgressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("StudentSectionProgress");
                });
            ...
            modelBuilder.Entity("Classroom.Domain.Entities.AssignmentAttempt", b =>
                {
                    b.Navigation("AssignmentQuestionAttempts");
                });
            ...
            modelBuilder.Entity("Classroom.Domain.Entities.Classroom", b =>
                {
                    ...
                    b.Navigation("CurriculumEnrollments");
                });
