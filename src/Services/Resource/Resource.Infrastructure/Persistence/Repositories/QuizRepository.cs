...
public class QuizRepository : EfRepositoryBase<ResourceDbContext, Quiz, int>, IQuizRepository
{
    public QuizRepository(ResourceDbContext context, ISieveProcessor sieveProcessor)
